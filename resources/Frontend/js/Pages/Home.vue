<template>
    <main>
        ...
        <section id="global-export" class="bg-[#FFFBEF]">
            <div class="container">
                <div class="relative">
                    <div
                    ...
                    <div class="relative py-[48px] md:py-[64px] xl:py-[100px]">
                        ...
                        <div class="headline-3 text-center text-gray-900 max-w-[900px] w-full mx-auto md:mt-4 mt-3 xl:mt-6 mb-8 md:mb-14 xl:mb-16">
