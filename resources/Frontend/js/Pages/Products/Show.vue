        ...
        <section id="harvest-seasons" class="md:py-16 py-12 xl:py-20 relative">
            ...
            <div class="relative">
                <div class="container">
                    ...
                    <div
                        class="body-1 text-gray-900 max-w-[630px] w-full mt-2 mb-6"
            ...
            <div class="container space-y-12">
                <div class="grid lg:grid-cols-2 gap-6 md:gap-8 xl:gap-20">
                    <div class="grid grid-cols-2 gap-3">
                        <JPicture
                            ...
                            :src="
                                product.images_product_process?.[0]?.url ||
                        ...
                        <div class="space-y-3 flex flex-col">
                            <JPicture
                                ...
                                class="w-full h-full object-cover"
                                :src="
                                    product.images_product_process?.[1]?.url ||
                            ...
                            <JPicture
                                ...
                                class="w-full h-full object-cover"
                                :src="
                                    product.images_product_process?.[2]?.url ||
                ...
                <div class="grid lg:grid-cols-2 gap-6 md:gap-8 xl:gap-20">
                    <div class="flex items-center justify-center">
                        <JPicture
                            ...
                            class="w-full h-full object-cover"
                            :src="
                                product.images_package_specification?.[0]?.url ||
                ...
                <div class="grid lg:grid-cols-2 gap-6 md:gap-8 xl:gap-20">
                    <div class="grid md:grid-cols-2 gap-[22px]">
                        <div
                            v-for="(itemMethod, indexMethod) in product.images_preservation_methods"
                            :key="indexMethod"
