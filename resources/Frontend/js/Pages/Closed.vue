        ...
        >
            <div class="px-6 py-8 md:px-10 md:py-12">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <h1 class="text-xl md:text-2xl font-semibold text-gray-900">Công ty TNHH Khơi Vị</h1>
                </div>
                ...
                <dl class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="flex items-start gap-3 p-4 rounded-xl bg-gray-50">
                        ...
                        <div>
                            ...
                            <dd class="font-medium text-gray-900">Công ty TNHH Khơi Vị</dd>
                        </div>
                    </div>
                ...
                <p class="mt-6 text-xs text-gray-500">
                    © {{ new Date().getFullYear() }} Công ty TNHH Khơi Vị. Mọi quyền được bảo lưu.
                </p>
            </div>
        </section>
    </main>
