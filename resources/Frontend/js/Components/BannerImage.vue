<template>
    <section>
        <div class="relative" :class="classBanner ? classBanner : 'h-[280px] md:h-[320px] xl:h-[330px]'">
            <div class="absolute inset-0">
                <JPicture :src="banner.image" loading="eager" class="object-fit h-full w-full object-cover"
                    :alt="banner.title" />
            </div>
            <div class="absolute bg-black/30 inset-0 w-full h-full"></div>
                ...
                <div class="container h-full flex items-center justify-center">
                    <div class="grid grid-cols-12 gap-4 md:gap-6 xl:gap-8">
                        <div
                            ...
                            <AnimatedAppear class="space-y-3 text-center text-white">
                                <h1 class="display-2 font-bold inline-block uppercase" v-html="banner.title"></h1>
