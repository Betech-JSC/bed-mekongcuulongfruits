...
export default {
    ...
    watch: {
        '$page.url': function (newUrl, oldUrl) {
            ...
            let seo_meta_title = seo?.seo_meta_title ?? global?.seo_meta_title ?? 'Vietnam Framer'
            let seo_meta_description = seo?.seo_meta_description ?? global?.seo_meta_description ?? 'Vietnam Framer'
            let seo_meta_robots = seo?.seo_meta_robots ?? global?.seo_meta_robots ?? 'robots.txt'
            let seo_meta_keywords = seo?.seo_meta_keywords ?? global?.seo_meta_keywords ?? 'Vietnam Framer'
