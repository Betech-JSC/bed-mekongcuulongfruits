        ...
        <template #default="{ form }">
            <div class="card">
                <div class="flex justify-between">
                    ...
                    <Link class="p-button btn-primary" :text="tt('models.table.create')"
            ...
            <div class="card">
                <div class="card-body">
                    <Field v-model="form.title_overview" :field="{
                        type: 'textarea',
                        name: 'title_overview',
                        label: 'Tiêu đề tổng quan',
                    }" />
                    <Field v-model="form.content_overview" :field="{
                        type: 'richtext',
                        name: 'content_overview',
                        label: 'Nội dung tổng quan',
                    }" />

                    <Field v-model="form.title_characteristics" :field="{
                        type: 'textarea',
                        name: 'title_characteristics',
                        label: 'Tiêu đề đặc điểm',
                    }" />
                    <Field v-model="form.content_characteristics" :field="{
                        type: 'richtext',
                        name: 'content_characteristics',
                        label: 'Nội dung đặc điểm',
                    }" />

                    <Field v-model="form.harvest_season" :field="{
                        type: 'richtext',
                        name: 'harvest_season',
                        label: 'Nội dung mùa vụ',
                    }" />

                    <Field v-model="form.product_packing" :field="{
                        type: 'richtext',
                        name: 'product_packing',
                        label: 'Quy trình đóng gói',
                    }" />

                    <Field v-model="form.product_preservation" :field="{
                        type: 'richtext',
                        name: 'product_preservation',
                        label: 'Phương pháp bảo quản',
                    }" />

                    <Field v-model="form.product_process" :field="{
                        type: 'richtext',
        ...
        <template #aside="{ form }">
            <div class="card">
                <div class="card-body">
                    ...
                    <Field v-model="form.view_count" :disabled="true" :field="{
                        type: 'number',
                        name: 'view_count',
                        label: 'Lượt xem',
                    }" />
                    <Field v-model="form.position" :field="{
                        type: 'number',
                        name: 'position',
                        label: 'Thứ tự sắp xếp',
                    }" />
                    <Field v-model="form.banner" :field="{
                        type: 'file_upload',
                        name: 'image',
